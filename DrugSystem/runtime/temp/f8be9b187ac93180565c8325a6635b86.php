    ...
    <div class="page-content">
        ...
        <div class="page-body">
            <button type="button" tooltip="取消" class="btn btn-sm btn-azure btn-addon"
                onClick="javascript:window.location.href = '/index/admin/listuser.html'"> <i
