<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\devTool\phpStudy\WWW\DrugSystem\public/../application/index\view\admin\modifyadmin.html";i:1592181199;s:73:"D:\devTool\phpStudy\WWW\DrugSystem\application\index\view\common\top.html";i:1592126752;s:74:"D:\devTool\phpStudy\WWW\DrugSystem\application\index\view\common\left.html";i:1592139257;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
            ...
            <ul class="submenu">
              ...
              <li>
                <a href="/index/admin/listmanager.html">
                  <span class="menu-text"> 库存管理员列表 </span>
                  <i class="menu-expand"></i>
                </a>
              </li>
              <li>
  ...
  <script src="http://localhost.drug/static/index/js/beyond.js"></script>
    ...
    <div class="page-content">
        ...
        <div class="page-body">
            <button type="button" tooltip="取消" class="btn btn-sm btn-azure btn-addon"
                onClick="javascript:window.location.href = '/index/admin/listadmin.html'"> <i
