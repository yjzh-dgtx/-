  ...
  <script src="http://localhost.drug/static/index/js/beyond.js"></script>
    ...
    <div class="page-content">
        ...
        <div class="page-body">
            ...
            <button type="button" tooltip="添加药品" class="btn btn-sm btn-azure btn-addon"
                onClick="javascript:window.location.href = '/index/admin/adddrug.html'"> <i class="fa fa-plus"></i>
                添加</button>
            <div class="row">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('admin/modifydrug',array('id'=>$vo['id'])); ?>"
                                                    class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 修改
                                                </a>
                                                <a href="#"
                                                    onClick="warning('确实要删除吗','<?php echo url('admin/deldrug',array('id'=>$vo['id'])); ?>')"
