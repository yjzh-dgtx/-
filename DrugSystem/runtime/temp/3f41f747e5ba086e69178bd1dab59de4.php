<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\devTool\phpStudy\WWW\DrugSystem\public/../application/index\view\admin\add.html";i:1592193121;s:73:"D:\devTool\phpStudy\WWW\DrugSystem\application\index\view\common\top.html";i:1592192611;s:74:"D:\devTool\phpStudy\WWW\DrugSystem\application\index\view\common\left.html";i:1592192894;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <ul class="submenu">
              <li>
                <a href="/index/admin/druglist.html">
                  <span class="menu-text"> 增加修改删除药品 </span>
                  <i class="menu-expand"></i>
                </a>
              </li>
            </ul>
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <div class="widget">
                        <div class="widget-header bordered-bottom bordered-blue">
                            <span class="widget-caption">新增人员</span>
                        </div>
                            ...
                            <div id="horizontal-form">
                                <form class="form-horizontal" role="form" action="<?php echo url('admin/add'); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" id="type" placeholder="1为系统管理员、2为库存管理员、3为用户"
                                                name="type" required="" type="number">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" id="number" placeholder="请输入电话" name="number"
                                                required="" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" id="address" placeholder="请输入地址" name="address"
                                                required="" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-default">确认添加系统成员</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
