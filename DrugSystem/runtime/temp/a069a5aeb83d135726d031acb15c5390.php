                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <div class="widget">
                        <div class="widget-header bordered-bottom bordered-blue">
                            <span class="widget-caption">修改药品</span>
                        </div>
                        <div class="widget-body">
                            <div id="horizontal-form">
                                <form class="form-horizontal" role="form" action="<?php echo url('admin/updatedrug'); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" id="drugname" placeholder="" name="drugname"
                                                required="" type="text" value="<?php echo $result['drugname']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" id="num" placeholder="" name="num" required=""
                                                type="text" value="<?php echo $result['num']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="attribute"
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" id="attribute" placeholder=""
                                                name="attribute" required=""><?php echo $result['attribute']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
